  ...
  return knex('forSale').del()
    .then(function () {
      ...
      return knex('forSale').insert([
        ...
        {id: 3, item: 'Chicken and Shitake Dumplings', course: "share", descirption: "Chicken dumplings uses fresh and dried shiitake mushrooms to give them a deep, meaty flavor", Img: "https://www.garlicandzest.com/wp-content/uploads/2016/02/pork-dumplings-6.jpg", price: 12},
        ...
        {id: 6, item: 'Fried Noodles', course: "Main", descirption: "Image result for fried noodlesHeat oil in a deep frying pan over medium flame. Deep fry boiled noodles in batches until light brown and crispy.", Img: "https://data.thefeedfeed.com/recommended/post_3911888.jpeg", price: 18, dietary: ""},
